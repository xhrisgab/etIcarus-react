  ...
  return (
    <div className=" flex justify-center flex-col">
      ...
      <div className="flex justify-center my-2">
        <input
          type="text"
          className="bg-icarus-4 border-3 border-icarus-2 text-black text-center font-bold rounded-xl"
          placeholder="Puerto seleccionado..."
          value={labelPort || "ninguno"}
          disabled
        />
        <button
          className={`p-2 justify-around bg-icarus-1 border-icarus-4 border-2  rounded-2xl  font-bold transition-all 
                        ${
                          isReading
